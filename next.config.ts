...
const cspHeader = `
    default-src 'self';
    script-src 'self' https://eu.posthog.com https://eu-assets.i.posthog.com https://eu.i.posthog.com 'unsafe-inline'${isDev ? " 'unsafe-eval'" : ''};
    worker-src 'self' https://eu.posthog.com https://eu-assets.i.posthog.com https://eu.i.posthog.com blob:;
