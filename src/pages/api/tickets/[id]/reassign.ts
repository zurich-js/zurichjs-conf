/**
 * Ticket Reassignment API (User-facing)
 * POST /api/tickets/[id]/reassign
 * Allows ticket owners to reassign their ticket using their secure token
 */
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    // Get the current ticket to save original owner info
