...
const faqSchemaData = [
  ...
  },
  {
    ...
    answer: "Switzerland has the perception of being pricey, but there are many ways to make a trip here affordable — some accommodation options come out at under €100 per night. We've found suitable places to stay at a range of price points, across travel regions and hotel types. Feel free to email hello@zurichjs.com if we can help you navigate how to plan the trip (accommodation, transport, or affordable places to eat).",
  },
  {
    question: "When is the best time to arrive and leave?",
    answer: "Community Day (Sept 9th) isn't essential, but if you're attending a workshop on the 10th, come early and enjoy it — the meetup agenda is at https://zurichjs.com/events/sep-2026 and you can RSVP at https://www.meetup.com/zurich-js/events/315488367/. Depart on Sept 12th — nothing's scheduled that day, so you're free to head home whenever suits you. VIP holders get exclusive access to the after party on the evening of Sept 11th, so don't book too early a departure that day.",
  },
];
