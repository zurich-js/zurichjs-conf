  ...
  public: {
    Tables: {
      ...
      session_feedback: {
        ...
        Relationships: [
          {
            foreignKeyName: "session_feedback_schedule_item_id_fkey"
            columns: ["schedule_item_id"]
            isOneToOne: false
            referencedRelation: "program_schedule_items"
            referencedColumns: ["id"]
          },
          {
    ...
    Functions: {
      ...
      door_hoodie_exclusion: {
        Args: { t: Database["public"]["Tables"]["tickets"]["Row"] }
        Returns: string
      }
      door_hoodie_verdicts: { Args: never; Returns: Json }
