...
export const scheduleData: Omit<ScheduleSectionProps, 'className'> = {
  ...
  days: [
    ...
    },
    {
      ...
      description: 'Accelerate your learning with a full day of hands-on workshops for Software Engineers from all domains. 6 in-depth, 4-hour workshops running across 3 parallel tracks in 2 blocks — morning and afternoon. All workshops are centrally hosted in Zurich.',
      tbaMode: false,
      events: [
        {
          time: '09:00 – 13:00',
          title: 'Morning Workshops (Track A, B & C)',
          description: '3 workshops running in parallel. Dive deep into hands-on, instructor-led sessions covering a range of JavaScript and web development topics.',
        },
        {
          time: '13:00 – 13:30',
          title: 'Lunch Break',
        ...
        {
          time: '13:30 – 17:30',
          title: 'Afternoon Workshops (Track A, B & C)',
          description: '3 workshops running in parallel. Continue learning with a fresh set of in-depth, hands-on sessions in the afternoon.',
        },
        {
          time: '19:00 – 22:00',
