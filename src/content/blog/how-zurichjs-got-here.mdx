...
- Want to have a direct impact? [Volunteer for ZurichJS Conf](https://conf.zurichjs.com).
- Sponsoring the local tech scene? [Reach your developer audience through ZurichJS](https://conf.zurichjs.com).

<p><small><i>Sources and further reading: Faris Aziz's [_Why it's called ZurichJS_](https://www.faziz-dev.com/blog/why-it-s-called-zurichjs), Faris's [_2025 in Review_](https://www.faziz-dev.com/blog/2025-in-review-a-year-of-exposure-compounding-and-trusting-my-gut), the [JSNation OSS Awards announcement](https://www.linkedin.com/posts/jsnation-the-main-js-conference_congrats-to-all-the-winners-of-the-open-activity-7474846182234771456-BOu0), and our ZurichJS sponsorship prospectus. For more on the values behind this, read Nadja's post on [why open source needs community](/blog/open-source-needs-community).</i></small></p>
