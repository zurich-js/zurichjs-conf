...
export const InfoBox: React.FC<InfoBoxProps> = ({ title, children }) => (
  <details className="group rounded-xl border border-blue-primary/20 bg-blue-primary/5 px-4 py-3">
    ...
    <div className="mt-3 pl-6 text-sm leading-relaxed text-gray-700 [&_a]:text-blue-primary [&_a]:underline [&_a:hover]:text-blue-dark">
      {children}
    </div>
  </details>
);
