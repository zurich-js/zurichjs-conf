...
const sizeStyles: Record<ButtonSize, string> = {
  ...
  md: 'p-2.5 text-md leading-relaxed',
  lg: 'p-3 text-lg leading-relaxed',
};

const variantStyles: Record<ButtonVariant, string> = {
  primary: 'bg-brand-yellow-main text-brand-black font-bold hover:bg-brand-yellow-secondary focus:ring-brand-yellow-secondary',
  ghost: 'bg-transparent text-brand-white border-2 border-text-primary font-medium hover:bg-text-primary hover:text-text-dark ',
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const baseStyles = 'inline-flex items-center justify-center gap-2 rounded-full transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed';
