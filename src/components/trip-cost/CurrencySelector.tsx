    ...
    <div className="flex flex-col items-center gap-2">
      <Listbox value={value} onChange={onChange}>
        <div className="relative">
          <ListboxButton className="cursor-pointer flex items-center gap-1.5 rounded-full border border-gray-300 bg-white pl-3.5 pr-2.5 py-1.5 shadow-sm hover:border-brand-gray-medium transition-colors">
          ...
          <ListboxOptions className="absolute z-50 mt-1 w-56 overflow-auto rounded-xl bg-white border border-brand-gray-lightest shadow-lg py-1 focus:outline-none left-1/2 -translate-x-1/2">
            {NATIVE_CURRENCIES.length > 0 && (
              <>
                <div className="px-3 py-1.5 text-[10px] font-semibold text-brand-gray-medium uppercase tracking-wider">
            ...
            {CONVERTED_CURRENCIES.length > 0 && (
              <>
                <div className="px-3 py-1.5 text-[10px] font-semibold text-brand-gray-medium uppercase tracking-wider mt-1 border-t border-text-brand-gray-lightest pt-2">
