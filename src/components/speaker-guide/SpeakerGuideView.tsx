            ...
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1fr_280px]">
              <div>
                ...
                <Link
                  ...
                  className="group mb-12 flex items-center gap-4 rounded-2xl border-2 border-brand-yellow-main/60 bg-brand-yellow-main/10 p-5 transition-colors hover:bg-brand-yellow-main/20 print:hidden"
                >
