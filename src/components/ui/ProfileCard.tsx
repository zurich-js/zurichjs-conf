 ...
 * Exact implementation from reactbits.dev
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const displayAvatarUrl = avatarUrl || `https://ui-avatars.com/api/?name=${encodeURIComponent(name || 'User')}&background=random&size=400`;
                ...
                <div className="pc-user-info">
                  <div className="pc-user-details">
                    <div className="pc-mini-avatar">
                      <img
                        src={miniAvatarUrl || displayAvatarUrl}
                        alt={`${name || 'User'} mini avatar`}
                        loading="lazy"
                        onError={e => {
                          const t = e.target as HTMLImageElement;
                          t.style.opacity = '0.5';
                          t.src = displayAvatarUrl;
                        }}
                      />
                    </div>
