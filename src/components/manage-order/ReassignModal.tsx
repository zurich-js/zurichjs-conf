      ...
      <div className="bg-brand-primary rounded-2xl max-w-md w-full p-8">
        ...
        <div className="flex gap-3">
          <button
            onClick={handleClose}
            disabled={mutation.isPending}
            className="flex-1 b[a-z]-brand-gray-lightest text-black font-semibold py-3 px-6 rounded-lg hover:bg-gray-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            Cancel
          </button>
          <button
