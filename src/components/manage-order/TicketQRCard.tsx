...
export function TicketQRCard({ qrCodeUrl }: TicketQRCardProps) {
  return (
    <div className="rounded-2xl border border-brand-gray-light bg-brand-gray-lightest p-8 mb-8">
      <h2 className="text-xl font-bold text-brand-black mb-6 text-center">Your Entry Pass</h2>
      <div className="flex flex-col items-center">
        {qrCodeUrl ? (
          <>
            ...
            <p className="text-brand-gray-darkest text-sm text-center max-w-md">
          ...
          <div className="text-center">
            <div className="bg-brand-white p-8 rounded-xl mb-4">
              <p className="text-brand-black text-lg mb-2">QR Code Generating...</p>
            ...
            <p className="text-brand-gray-darkest text-sm max-w-md">
