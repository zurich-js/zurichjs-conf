  ...
  return (
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="p-4 sm:p-6 border-b border-brand-gray-lightest bg-gradient-to-r from-gray-50 to-white">
          <div className="flex items-start justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-brand-gray-dark mt-0.5">
          ...
          <InfoSection title="Attendee Information">
            <InfoGrid>
              ...
              <div className="sm:col-span-2">
                ...
                <p className="text-xs text-brand-gray-medium mb-1">Billing country from checkout</p>
                {isEditingCountry ? (
                  <div className="space-y-2">
                    <div className="relative">
                      ...
                      />
                      {showDropdown && (
                        <div className="absolute z-10 w-full mt-1 bg-white border border-brand-gray-lightest rounded-lg shadow-lg max-h-48 overflow-y-auto">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="p-1 text-brand-gray-medium hover:text-brand-gray-dark cursor-pointer"
                      title="Edit country"
                    >
          ...
          {ticket.qr_code_url && (
            <InfoSection title="QR Code">
              <div className="flex justify-center">
                <img src={ticket.qr_code_url} alt="Ticket QR Code" className="w-32 h-32 border border-brand-gray-lightest rounded-lg" />
              </div>
            </InfoSection>
          )}
        </div>
...
function InfoField({ label, description, className, children }: { label: string; description?: string; className?: string; children: React.ReactNode }) {
  return (
    <div className={className}>
      ...
      {description && <p className="text-xs text-brand-gray-medium mb-1">{description}</p>}
