...
export function ConfirmModal({
  ...
  const buttonBg = confirmColor === 'red' ? 'bg-red-600 hover:bg-red-700' : 'bg-brand-gray-dark hover:bg-gray-700';
        ...
        <div className="p-4 sm:p-6 border-b border-brand-gray-lightest">
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-brand-gray-dark mt-1">{message}</p>
            </div>
          </div>
        </div>
        <div className="p-4 sm:p-6">
          {details && details.length > 0 && (
            <div className="bg-gray-50 rounded-lg p-3 sm:p-4 border border-brand-gray-lightest mb-4 sm:mb-6">
