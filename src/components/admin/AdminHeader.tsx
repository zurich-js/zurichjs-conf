...
import { BarChart3, FileText, Plane, Users, LogOut, Menu, X, Handshake, Building2, ShieldCheck, ScanLine, ChevronDown, QrCode, MessageSquareText, Network, type LucideIcon } from 'lucide-react';
