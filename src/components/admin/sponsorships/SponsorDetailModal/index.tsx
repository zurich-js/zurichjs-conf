          ...
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center gap-3 min-w-0 flex-1">
              <div className="relative h-10 w-10 sm:h-12 sm:w-12 rounded-lg bg-gray-100 overflow-hidden flex-shrink-0">
                {sponsor.logo_url ? (
                  <Image src={sponsor.logo_url} alt={sponsor.company_name} fill sizes="48px" className="object-contain p-1" unoptimized={sponsor.logo_url.endsWith('.svg') || sponsor.logo_url.endsWith('.gif')} />
                ) : (
