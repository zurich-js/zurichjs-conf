...
import { X, Mail, Check, ImageIcon, FileText, Gift, Ticket } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
        ...
        <div className="relative inline-block w-full max-w-lg bg-white rounded-lg text-left overflow-hidden shadow-xl transform sm:my-8">
          {/* Header */}
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              ...
              <p className="text-sm text-gray-600">{partnership.contact_email}</p>
            </div>

            {/* Options */}
            <div>
              <h4 className="text-sm font-medium text-gray-900 mb-3">Include in email</h4>
              <div className="space-y-3">
                <label className="flex items-center gap-3 p-3 border rounded-lg hover:bg-gray-50 cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">Include all active discount codes</p>
                  </div>
                </label>
                ...
                <label className="flex items-center gap-3 p-3 border rounded-lg hover:bg-gray-50 cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">Include all unredeemed vouchers</p>
                  </div>
                </label>
                ...
                <label className="flex items-center gap-3 p-3 border rounded-lg hover:bg-gray-50 cursor-pointer">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">Include ZurichJS logo in email</p>
                  </div>
                </label>
                ...
                <label className="flex items-center gap-3 p-3 border rounded-lg hover:bg-gray-50 cursor-pointer">
                  <input
                    type="checkbox"
                    checked={options.include_banner}
                    onChange={(e) =>
                      setOptions((prev) => ({ ...prev, include_banner: e.target.checked }))
                    }
                    className="rounded text-[#F1E271] focus:ring-[#F1E271]"
                  />
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">Include conference banner</p>
                  </div>
                </label>
              </div>
            </div>
            ...
            <div className="flex justify-end gap-3 pt-4 border-t">
              ...
              <button
                ...
                className="px-4 py-2 bg-[#F1E271] text-black font-medium rounded-lg hover:bg-[#E5D665] disabled:opacity-50 flex items-center gap-2"
              >
